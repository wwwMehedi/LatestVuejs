<template>
  ...
  <form class="needs-validation" novalidate name="form" @submit.prevent="add()">
    ...
    <input type="text" @keyup.prevent="map_addressm()" class="form-control" v-model="map_address">
    <p class="text-danger">{{cityname}}</p>
      </div>
...
// db.collection('property_type').get().then(property_type => {
//   console.log("indexeddb::");
//   this.property_type = property_type
//   console.log(property_type)
//   // in this block i will create logic
//   let a = this.property_type;
//   console.log(a);
// console.log("property_type value is::");
// })
// db.collection('show').get().then(show =>{
//   console.log("indexeddb::");
//   this.show = show
//   console.log(show)
// })
 ...
 view() {
   console.log("server is calling")
    ...
    add(){ 
       if(this.map_address=='' || this.map_address==null){ 
        this.cityname="this fild is requred"  
      }else
      this.loading=true;
      db.collection('property_type').add({ 
