...
<div class="col-md-6 border pb-3 pl-2 colh">
  ...
  <div class="row" >
  <PuSkeleton class="abc" v-if="loading" height="40px"></PuSkeleton>
		<div v-else class="abc roomsandbeds d-flex align-items-start backgrnd"><h4>Rooms and Beds</h4></div>
    <div class="row"></div>
    <PuSkeleton class="col-md-6" v-if="loading" height="40px"></PuSkeleton>
...
<div class="row mt-5">
<PuSkeleton class="abc" v-if="loading" height="40px"></PuSkeleton>
		<div v-else class="abc Listings d-flex align-items-start backgrnd"><h4>Listings</h4></div>
    <PuSkeleton class="col-md-6" v-if="loading" height="40px"></PuSkeleton>
		<div v-else class="col-md-6">
...
<PuSkeleton class="" color="#eee" v-if="loading"></PuSkeleton>
<button type="submit" v-else class="btn btn-danger mt-4"><span>Next</span></button>
</div>
...
export default {
  ...
  mounted(){ 
    ...
    if(localStorage.getItem("totalbedrooms")&&localStorage.getItem("totalbedd")
...
idb(){ 
db.collection('sajibtwo').get().then(sajibtwo => {
  console.log("below localbase stored::")
  console.log(sajibtwo.accomodate)
})
    },
    view() {
      this.loading=true
